...
export default function CookieConsent() {
  ...
  return (
    <>
      {/* Push cookie banner above the 64px mobile bottom nav bar */}
      <style>{`
        .ram-cookie-banner {
          bottom: 0;
          z-index: 9999;
        ...
        @media (max-width: 1023px) {
          .ram-cookie-banner {
            bottom: 72px; /* 64px nav + 8px breathing room */
          }
        }
      `}</style>
      <div
        ...
        className="ram-cookie-banner fixed left-0 right-0 bg-white border-t border-gray-200 shadow-[0_-4px_24px_rgba(0,0,0,0.08)]"
      >
