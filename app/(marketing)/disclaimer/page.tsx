...
Right Assets Management is not a law firm and does not offer legal services as defined under the Advocates Act, 1961. We do not represent clients in courts, tribunals, or before any judicial or quasi-judicial authority.

**Advisory Only:**
Legal guidance provided by Right Assets Management is general advisory in nature, intended to help you understand your situation and available options. It is not a substitute for a formal legal opinion from a qualified advocate engaged for your specific matter.

**No Advocate-Client Relationship:**
Unless you have signed a formal retainer agreement with an empanelled advocate of Right Assets Management, no advocate-client relationship exists. Information shared with us during initial consultations is not protected by advocate-client privilege.
...
**External Links:**
This Website may contain links to third-party websites for reference purposes. Right Assets Management does not endorse, control, or take responsibility for the content, accuracy, or practices of any third-party website. Accessing third-party links is at your own risk.`,
  },
  {
    id: "no-professional-relationship",
    title: "6. No Professional Relationship from Website Use",
    content: `Accessing this Website, reading its content, using our calculators, or filling out an enquiry form does not create any professional or advisory relationship between you and Right Assets Management. A formal advisory relationship is established only upon execution of a written engagement agreement signed by an authorised representative of the Company.
...
Forward-looking statements involve known and unknown risks, uncertainties, and other factors that may cause actual results to differ materially from those expressed or implied. Right Assets Management does not undertake any obligation to update forward-looking statements to reflect new information, future events, or changed circumstances.`,
  },
  {
    id: "limitation-of-liability",
    title: "8. Limitation of Liability",
    content: `To the fullest extent permitted by law, Right Assets Management, its directors, employees, advisors, empanelled advocates, and agents shall not be liable for:
...
This limitation applies regardless of the legal theory under which liability is claimed (contract, tort, strict liability, or otherwise) and even if Right Assets Management has been advised of the possibility of such damages.`,
  },
  {
    id: "regulatory",
