...
export default async function RealEstateServicePage({
  ...
  if (!svc || svc.vertical !== "real-estate") notFound();
      ...
      >
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          <svg className="absolute inset-0 w-full h-full" style={{ opacity: 0.04 }}>
            <defs>
              <pattern id="re-svc-grid" x="0" y="0" width="56" height="56" patternUnits="userSpaceOnUse">
                <path d="M 56 0 L 0 0 0 56" fill="none" stroke="#C9A84C" strokeWidth="0.8" />
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#re-svc-grid)" />
          </svg>
        </div>
                  ...
                  <ul className="space-y-3">
                    {svc.whoIsItFor.map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: "#0D7E7E" }} />
                    ...
                    {svc.process.map((step) => (
                      <div key={step.step} className="flex gap-4">
                        <div
                          ...
                          style={{ backgroundColor: "#E6F4F4", color: "#0D7E7E" }}
                        >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {svc.documentsRequired.map((doc, i) => (
                      ...
                      >
                        <FileText className="w-4 h-4 flex-shrink-0" style={{ color: "#0D7E7E" }} />
              ...
              {related.map((rel) => {
                ...
                return (
                  <Link
                    ...
                    style={{ border: "1px solid #E5E7EB" }}
                  >
                    <div className="w-2 h-10 rounded-full flex-shrink-0 mt-0.5" style={{ backgroundColor: "#0D7E7E" }} />
